---
layout: post
title: SOC Level 1 Challenges – Boogeyman 3
date: 2024-10-13 20:07
author: yurenjoeysie
comments: true
categories: [Endpoint Security, Hash, Incident Response, Kibana, Linux Forensics, logs, Malware Analysis, Network Forensics, Network Security, Phishing, PhishTool, PowerShell, Ransomware, Sysmon, Threat Intelligence, TryHackMe Challenge Rooms, Windows Event Logs, Windows Forensic]
---
<!-- wp:paragraph {"backgroundColor":"tertiary","fontSize":"small"} -->
<p class="has-tertiary-background-color has-background has-small-font-size">Click <a href="https://tryhackme.com/r/room/boogeyman3">here</a> to enter the challenge room on Try Hack Me</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"style":{"color":{"text":"#74103e"},"elements":{"link":{"color":{"text":"#74103e"}}}},"fontSize":"large"} -->
<h1 class="wp-block-heading has-text-color has-link-color has-large-font-size" style="color:#74103e">Introduction</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"justify","fontSize":"small"} -->
<p class="has-text-align-justify has-small-font-size">Following previous attacks by the Boogeyman, Quick Logistics LLC hired a managed security service provider to oversee its Security Operations Center. However, the Boogeyman remained undetected, waiting for the right opportunity to strike again.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"justify","fontSize":"small"} -->
<p class="has-text-align-justify has-small-font-size">After receiving the phishing email report, the security team investigated the CEO's workstation. They found the email attachment in the downloads folder.<br><br>The security team also identified a file within the ISO payload, as shown in the image below. The security team determined that the incident likely occurred between August 29 and August 30, 2023. Based on these initial findings, we are tasked with analyzing and assessing the impact of the compromise.</p>
<!-- /wp:paragraph -->
